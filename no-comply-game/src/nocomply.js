                    ...
                    [
                        {
                          ...
                          url : "src/city/intro_city-anim.dae",
                          load : colladaLoader,
                      ...
                      oncomplete : function() {
                        ...
                        localRequire( [ 'bitwall-model' ], function(
                          ...
                          bossBitwall = new BitwallModel( {
                            spriteURL : 'src/sprites/thug1.sprite',
                            action : 'walk-front'
                          } );
                          playerBitwall = new BitwallModel( {
                            spriteURL : 'src/sprites/kraddy.sprite',
                            action : 'jump'
                          } );
